...
export default function MyResentProject() {
  return (
    <section id="my-recent-project" className="relative mx-4 mb-16 lg:max-w-6xl lg:mx-auto">
      <div className="hidden md:block my__recent__work__glow absolute top-96 left-[250px]" />
