    ...
    <article className="relative w-full max-w-sm">
          ...
          {binaryMatrix.map((row, rowIndex) => (
            <div key={rowIndex} className="flex gap-1 mb-1">
              {row.map((bit, colIndex) => (
                <span
                  key={colIndex}
                  className="text-white font-poppins text-xs opacity-20 binary-char"
                  style={{
      ...
      >
        ...
        <div className="relative z-20 p-8 flex items-center justify-center">
          <div className="relative w-54 h-54 md:w-64 md:h-64 lg:w-80 lg:h-80 group/image-container">
            {/* Outer glow ring */}
            ...
            <div className="absolute -inset-4 rounded-full border-2 border-[rgba(32,191,85,0.4)] opacity-40 animate-rotate-slow">
              <div className="absolute top-0 left-1/2 -translate-x-1/2 font-poppins text-sm" style={{ color: "rgba(32, 191, 85, 0.7)" }}>
                01001000
              </div>
              <div className="absolute bottom-0 left-1/2 -translate-x-1/2 font-poppins text-sm" style={{ color: "rgba(32, 191, 85, 0.7)" }}>
                01101001
              </div>
              <div className="absolute left-0 top-1/2 -translate-y-1/2 -rotate-90 font-poppins text-sm" style={{ color: "rgba(32, 191, 85, 0.7)" }}>
                01001000
              </div>
              <div className="absolute right-0 top-1/2 -translate-y-1/2 rotate-90 font-poppins text-sm" style={{ color: "rgba(32, 191, 85, 0.7)" }}>
                01101001
              </div>
            </div>
